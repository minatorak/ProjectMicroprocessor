...
public class SettingsToggle extends RelativeLayout implements View.OnClickListener {
    ...
    public SettingsToggle(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public SettingsToggle(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
